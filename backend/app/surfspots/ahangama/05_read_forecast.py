...
BOUNDARY_FILE = "ahangama_boundary.bnd"
...
def main():
    ...
    if df_bnd is None:
        print("Critical: Boundary file missing. Cannot determine input energy.")
        return
    if df_surf is None:
        print("Critical: SWAN output missing. Did you run './swanrun'?")
        return
    ...
    json_filename = "ahangama_forecast.json"
